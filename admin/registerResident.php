...
if(isset($_POST['submit'])) {
    ...
    $targetDir = "../resident/img/resident/";
    ...
    if($check !== false) {
        ...
        if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif") {
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
                ...
                $query = "INSERT INTO resident (r_name, r_phn, r_email, r_pass, r_address, r_img) VALUES ('$name', '$contact', '$email', '$password', '$address', '$targetFile')";
...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Resident Registration</h1>
    <!-- Registration Form -->
